        ...
        <tr align="center">
					    ...
					    <c:choose>
					      <c:when test="${requestScope.pageBean.pageNum != 1}">
					        <a href="${pageContext.request.contextPath }/stumenue/courseFind?pageNum=1">首页</a>
					        <a href="${pageContext.request.contextPath }/stumenue/courseFind?pageNum=${requestScope.pageBean.pageNum -1}">上一页</a>
					      </c:when>
					      <c:when test="${requestScope.pageBean.pageNum != requestScope.pageBean.totalPage}">
					        <a href="${pageContext.request.contextPath }/stumenue/courseFind?pageNum=${requestScope.pageBean.pageNum +1}">下一页</a>
					        <a href="${pageContext.request.contextPath }/stumenue/courseFind?pageNum=${requestScope.pageBean.totalPage}">末页</a>
					      </c:when>
